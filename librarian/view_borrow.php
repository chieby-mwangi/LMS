...
while ($row = mysqli_fetch_array($user_query)) {
    ...
    // Display or process each row of data as needed
    // Example: Outputting some information
    echo "Borrow ID: " . $borrow_id . "<br>";
    echo "Book ID: " . $book_id . "<br>";
    echo "Borrow Details ID: " . $borrow_details_id . "<br>";

    // You can access other columns as needed, e.g., $row['member_id'], $row['firstname'], etc.
}
?>
